...
# Load dataset
data_path = os.path.join('..', '..', 'core_data', 'prediction_data', 'stroke_cleaned_final.csv')
...
output_dir = os.path.join(BASE_DIR, 'data_processing', 'processed_data')
...
with open(os.path.join(BASE_DIR, 'data_processing', 'preprocessed_data.pkl'), 'wb') as f:
...
print(f"\nData preparation complete and saved to '{os.path.join(BASE_DIR, 'data_processing', 'preprocessed_data.pkl')}'")
